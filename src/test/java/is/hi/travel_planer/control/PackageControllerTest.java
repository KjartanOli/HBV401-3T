...
public class PackageControllerTest {
	...
	public void setUp() {
		...
		var id_test2 = "F-101";
		ArrayList<Seat> seats_test2 = new ArrayList<>();
		seats_test2.add(new Seat("A-1", id_test2, false));
		seats_test2.add(new Seat("A-2", id_test2, false));
		seats_test2.add(new Seat("A-3", id_test2, false));
		seats_test2.add(new Seat("A-4", id_test2, false));
		seats_test2.add(new Seat("B-1", id_test2, false));
		seats_test2.add(new Seat("B-2", id_test2, false));
		seats_test2.add(new Seat("B-3", id_test2, false));
		seats_test2.add(new Seat("B-4", id_test2, false));
		var f_test2 = new Flight(id_test2, seats_test2, "Keflavík", "Egilsstaðir", LocalDate.of(2023, 4, 2),
		...
		expected_test2.add(new TravelPackage(f_test2, h_test2, t_test2, user_test2.getTripDuration()));
	}
